                ...
                {isListening ? (
                  ...
                  <div className="flex items-center gap-2 w-full">
                    <button
                      ...
                      disabled={loading}
                      className={`size-7 shrink-0 rounded-lg flex items-center justify-center transition-all duration-150 cursor-pointer ${menuOpen ? "bg-white/15 text-white" : "bg-white/5 text-white/70 hover:bg-white/10 hover:text-white"} disabled:opacity-30`}
                    >
