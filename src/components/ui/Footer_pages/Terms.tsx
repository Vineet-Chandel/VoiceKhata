...
const sections = [
    { title: "1. Acceptance of Terms", body: "By accessing or using VoiceKhata, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use the service." },
    { title: "2. Description of Service", body: "VoiceKhata is a personal finance management platform that provides expense tracking, budgeting tools, financial analytics, and AI-powered insights. The service is provided 'as is' and may be updated at any time." },
    ...
    { title: "4. Acceptable Use", body: "You agree not to misuse the service, attempt to access other users' data, reverse engineer the application, or use VoiceKhata for any illegal financial activity. Violations may result in immediate account termination." },
    { title: "5. Financial Information Disclaimer", body: "VoiceKhata provides financial tools and AI insights for informational purposes only. Nothing in the service constitutes professional financial advice. Always consult a qualified financial advisor before making significant financial decisions." },
    ...
    { title: "9. Limitation of Liability", body: "VoiceKhata Technologies Pvt. Ltd. shall not be liable for any indirect, incidental, or consequential damages arising from your use of the service. Our total liability is limited to the amount paid in the past 12 months." },
            ...
            <div className="relative z-10 px-6 pt-20 pb-20 max-w-3xl mx-auto">
                <motion.div initial="hidden" animate="visible" variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.06 } } }}>
                    ...
                    <motion.p variants={itemV} className="text-sm leading-relaxed mb-10" style={{ color: "#555" }}>
                        Please read these terms carefully before using VoiceKhata. By using the service, you agree to these terms.
                    </motion.p>
                    {sections.map((s, i) => (
