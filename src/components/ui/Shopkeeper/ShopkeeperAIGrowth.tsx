...
export function ShopkeeperAIGrowth() {
  ...
  return (
    <section id="growth" className="py-16 sm:py-24 bg-[#0B0F19] border-y border-slate-700/40 font-sans">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-[#F8FAFC] tracking-tight font-heading leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
            ...
            <div className="rounded-3xl border border-slate-700/40 bg-[#131B2E] p-6 sm:p-8 backdrop-blur-xl shadow-2xl">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-700/40 pb-6 mb-6">
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="text-xl font-bold text-[#F8FAFC] font-heading">Financial Health Score</h3>
                  ...
                  <p className="text-xs text-[#94A3B8] mt-1">Real-time status calculated from income, expenses, and credit recovery.</p>
                </div>

                <div className="flex items-center gap-4 rounded-2xl bg-[#0E1322] border border-slate-700/40 px-5 py-3 shrink-0">
                  <div className="text-right">
                    <span className="text-[10px] font-bold text-[#94A3B8] uppercase tracking-wider block">Score</span>
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-[#94A3B8]">Excellent</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="rounded-2xl border border-slate-800/60 bg-[#0E1322] p-3 text-center">
                  <span className="text-[10px] font-semibold text-[#94A3B8] block mb-1">Cash Flow</span>
                ...
                <div className="rounded-2xl border border-slate-800/60 bg-[#0E1322] p-3 text-center">
                  <span className="text-[10px] font-semibold text-[#94A3B8] block mb-1">Emergency Fund</span>
                  <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden mb-1.5">
                ...
                <div className="rounded-2xl border border-slate-800/60 bg-[#0E1322] p-3 text-center">
                  <span className="text-[10px] font-semibold text-[#94A3B8] block mb-1">Credit Risk</span>
                  <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden mb-1.5">
                ...
                <div className="rounded-2xl border border-slate-800/60 bg-[#0E1322] p-3 text-center">
                  <span className="text-[10px] font-semibold text-[#94A3B8] block mb-1">Savings Rate</span>
                  <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden mb-1.5">
            ...
            <div className="rounded-3xl border border-violet-500/30 bg-gradient-to-br from-violet-950/40 via-slate-900/90 to-black p-6 sm:p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 text-xs">
                <div className="rounded-xl bg-[#0E1322] border border-slate-700/40 p-3">
                  <span className="text-[#94A3B8] font-medium block">Why it matters:</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] text-[#94A3B8]">Automated 1-click execution</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
            ...
            <div className="rounded-3xl border border-slate-700/40 bg-[#131B2E] p-6 sm:p-8 backdrop-blur-xl shadow-2xl">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-[#94A3B8]">Adapts automatically with carry-forward support</p>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1">
                    <span className="text-[#94A3B8]">Inventory & Stock</span>
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1">
                    <span className="text-[#94A3B8]">Logistics & Fuel</span>
                ...
                <div>
                  <div className="flex justify-between text-xs font-medium mb-1">
                    <span className="text-[#94A3B8]">Utilities & Electricity</span>
            ...
            <div className="rounded-3xl border border-rose-500/30 bg-[#131B2E] p-6 sm:p-8 backdrop-blur-xl shadow-2xl">
              <div className="flex items-center gap-2 mb-2">
                <HelpCircle className="size-4 text-rose-400" />
                <h4 className="text-base font-bold text-[#F8FAFC] font-heading">Interactive Simulator: "Can I Afford This?"</h4>
              </div>
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-center justify-between gap-3">
                  <label className="text-xs text-[#94A3B8] font-medium">Planned Purchase:</label>
