    ...
    <>
      ...
      {showVoiceSheet && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/75 p-0 sm:p-4 backdrop-blur-xs md:hidden">
          <div className="w-full max-w-lg bg-[#1E293B] rounded-t-[18px] sm:rounded-[14px] border border-[#334155] p-4 shadow-2xl space-y-3 max-h-[85vh] overflow-y-auto text-[#F8FAFC]">
            <div className="flex items-center justify-between pb-2 border-b border-[#334155]">
              ...
              <button
                ...
                className="size-8 rounded-full flex items-center justify-center hover:bg-[#253349] text-[#94A3B8]"
              >
                <X size={18} />
              </button>
            </div>
      ...
      <nav 
        ...
        className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around h-16 bg-[#1E293B] border-t border-[#334155] px-2 py-1 shadow-lg md:hidden"
      >
        {/* First 2 items */}
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center flex-1 min-h-[44px] py-1 text-[11px] font-medium transition-colors ${
                isActive ? "text-[#818CF8] font-semibold" : "text-[#94A3B8] hover:text-[#F8FAFC]"
              }`}
            >
